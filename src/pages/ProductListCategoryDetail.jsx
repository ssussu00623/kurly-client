...
export default function ProductListCategoryDetail() {
  ...
  useEffect(()=> { 
    const fetchCategoryData = async() =>{
      try {
       const result =  
        (categorySid === undefined) ? await axios.post('http://13.209.41.189:9000/main/categories', {cid : categoryCid})
         : await axios.post('http://13.209.41.189:9000/main/subcategories', {cid : categoryCid, sid: categorySid});
