...
export default function ProductListCategoryDetail() {
  ...
  useEffect(()=> { 
    const fetchCategoryData = async() =>{
      try {
       const result =  
        (categorySid === undefined) ? await axios.post('http://43.201.27.254:9000/main/categories', {cid : categoryCid})
         : await axios.post('http://43.201.27.254:9000/main/subcategories', {cid : categoryCid, sid: categorySid});
