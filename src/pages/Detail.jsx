...
export default function Detail() {
    ...
    useEffect(() => {
        axios.post('http://43.201.27.254:9000/product/detail', { 'pid': pid })
            .then((res) => {
        ...
        try {
            ...
            if(wishList !==null){
                setWishList((prevWishList)=>{
                   ...
                   axios.post("http://43.201.27.254:9000/main/wishListUpdate", {id, wishList :updateWishList})
                        .then((res)=>{
                            if(res.data === 1 ){
                ...
                <div className="inner">
                    <div className="top_info" ref={topInfoRef}>
                        ...
                        <div className="img_area">
                            <div className="img">
                                <img src={`http://43.201.27.254:9000/${product.image_url}`} alt={product.name} />
                                <div className="dc">+{product.discountRate} 쿠폰</div>
                                <div className="payback">페이백</div>
                            </div>
                            <div className="brand">
                                <div className="thumb"><img src={`http://43.201.27.254:9000/${product.image_url}`} alt={product.brand} /></div>
