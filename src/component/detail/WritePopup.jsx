    ...
    const handleSubmit = (e) => {
        ...
        if(validator()){
            if(fnames.uploadname){
                ...
                axios.post('http://13.209.41.189:9000/review',formData)
                    .then(res =>{
                ...
                axios.post('http://13.209.41.189:9000/inquire',formData)
                    .then(res =>{
                        if(res.data.affectedRows === 1)  setUpdate(1)
                    })
                    .catch(err => console.log(err));
         ...
         <div className="inquire_area">
                    <div className="box_area" style={{height : file ? '800px' : '690px'}}>
                        ...
                        <div className="product">
                            <div className="thumb"> <img src={`http://13.209.41.189:9000/${src}`} alt={name} /></div>
                            <div>{name}</div>
                        </div>
