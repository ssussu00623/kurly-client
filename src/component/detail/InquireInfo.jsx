...
export default function InquireInfo({src, name, pid}) {
    ...
    useEffect(() => {
        ...
        axios.post('http://13.209.41.189:9000/inquire/getList',{'pid':pid})
    ...
    const handleAnswer = async (iid) => {
        if (!textRef.current.value.trim()) {
            ...
            try{
                const result = await axios.post('http://13.209.41.189:9000/inquire/answer',{'iid':iid,'text':textRef.current.value})
