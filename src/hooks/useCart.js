    ...
    export function useCart() {
        ...
        ********************************************/
        ...
        const deleteCartItem = async (no) => {
            const result = await axios.delete("http://43.201.27.254:9000/cart/deleteItem", { data: { "no": no } })
        ...
        *******************************************/
                ...
                const deleteCheckedItems = async (nos) => {
                    const result = await axios.delete("http://43.201.27.254:9000/cart/deleteCheck", {
                        data: { nos } 
                    });
    ...
    ********************************************/
    const getUserAddress = async () => {
        ...
        try {
            const res = await axios.post("http://43.201.27.254:9000/member/mypage", { id });
            if (res.data) {
                setCartAddress({
