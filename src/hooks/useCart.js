    ...
    export function useCart() {
        ...
        ********************************************/
                const getCartList = async () => {
                    ...
                    const result = await axios.post("http://13.209.41.189:9000/cart/items", { "id": id });
        ...
        ********************************************/
        const saveToCartList = async (formData) => {
            const result = await axios.post("http://13.209.41.189:9000/cart/add", formData);
        ...
        ********************************************/
        const updateCartList = async (no, type, qty) => {
            ...
            const result = await axios.put('http://13.209.41.189:9000/cart/updateQty',
        ...
        ********************************************/
        const getCount = async () => {
            ...
            const id = localStorage.getItem("user_id");
            if (id.length) {
                const result = await axios.post("http://13.209.41.189:9000/cart/count", { "id": id })
        ...
        ********************************************/
        ...
        const deleteCartItem = async (no) => {
            const result = await axios.delete("http://13.209.41.189:9000/cart/deleteItem", { data: { "no": no } })
        ...
        *******************************************/
                ...
                const deleteCheckedItems = async (nos) => {
                    const result = await axios.delete("http://13.209.41.189:9000/cart/deleteCheck", {
                        data: { nos } 
                    });
    ...
    ********************************************/
    const getUserAddress = async () => {
        ...
        try {
            const res = await axios.post("http://13.209.41.189:9000/member/mypage", { id });
            if (res.data) {
                setCartAddress({
